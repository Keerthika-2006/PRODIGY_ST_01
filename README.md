...
Validate handling of decimal and negative numbers

Ensure correct implementation of BODMAS (operator precedence)
...
Navigate to prodigy task 1.md

Execute the test steps manually
